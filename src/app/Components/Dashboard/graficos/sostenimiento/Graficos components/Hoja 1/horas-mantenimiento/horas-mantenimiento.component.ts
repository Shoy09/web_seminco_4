...
@Component({
  selector: 'app-horas-mantenimiento',
  standalone: true,
  imports: [NgxEchartsDirective],
  providers: [provideEchartsCore({ echarts })],
  templateUrl: './horas-mantenimiento.component.html',
  styleUrl: './horas-mantenimiento.component.css'
})
export class HorasMantenimientoComponent implements OnChanges {
  @Input() data: any[] = [];
