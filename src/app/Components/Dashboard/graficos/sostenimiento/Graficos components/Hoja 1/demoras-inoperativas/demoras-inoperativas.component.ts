...
@Component({
  selector: 'app-demoras-inoperativas',
  standalone: true,
  imports: [NgxEchartsDirective],
  providers: [provideEchartsCore({ echarts })],
  templateUrl: './demoras-inoperativas.component.html',
  styleUrl: './demoras-inoperativas.component.css'
})
export class DemorasInoperativasComponent implements OnChanges {
  @Input() data: any[] = [];
  ...
  ngOnChanges(changes: SimpleChanges): void {
    if (changes['data']) {
      //console.log('📊 DEMORAS INOPERATIVAS RECIBIDAS:', this.data);
