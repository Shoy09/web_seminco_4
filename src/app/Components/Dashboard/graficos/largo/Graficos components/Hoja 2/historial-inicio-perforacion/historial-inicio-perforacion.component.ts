...
@Component({
  selector: 'app-historial-inicio-perforacion',
  standalone: true,
  imports: [NgxEchartsDirective],
  providers: [provideEchartsCore({ echarts })],
  templateUrl: './historial-inicio-perforacion.component.html',
  styleUrl: './historial-inicio-perforacion.component.css'
})
export class HistorialInicioPerforacionComponent implements OnChanges {
  ...
  updateChart(): void {
    ...
    this.data.forEach(item => {
      ...
      const valor = item.promedio_primera_perf_dia_fr || 0;
