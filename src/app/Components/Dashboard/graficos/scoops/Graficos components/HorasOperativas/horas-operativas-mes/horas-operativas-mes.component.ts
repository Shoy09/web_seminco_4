...
@Component({
  ...
  templateUrl: './horas-operativas-mes.component.html',
  styleUrl: './horas-operativas-mes.component.css',
})
export class HorasOperativasMesComponent implements OnInit, OnChanges {
  @Input() data: any[] = [];
