...
export class PrincipalAnfochargerComponents implements OnInit {
...
formatearHorometros(data: any) {
  ...
  return {
    ...
    horometro_principal: data.horometro_principal ? map(data.horometro_principal) : null,
  };
}
...
mapearParaHorometros(op: OperacionBase) {
  ...
  return {
    ...
    horometro_principal: h.horometro_principal || null,
  };
}
